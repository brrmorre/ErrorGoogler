...
guessResearchPage searchResultGoogleHTML = getFirstStackOverflowURL(searchResultGoogleHTML) --guess the stackoverflowpage
...
askCoworker = --ask coworker how to do something
