...
duckduckgoconverter searchString = quote duckduckgo.com/search?qequals quote plus uRLConverter SearchString-- convert a search string into a duckduckgo search url
