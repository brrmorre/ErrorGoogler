...
duckduckgoConverter searchString = appendDuckduckgoJunk(prependDuckduckgoJunk(uRLConverter(searchString))) -- convert a search string into a duckduckgo search url
